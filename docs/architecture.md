...
Capturas de widgets a 390 × 844: [landing con una cuenta](images/single-account-landing.png) y [recorrido integrado](images/dashboard-inline-tour.png). Son referencias visuales con fuente de prueba, no capturas de dispositivo nativo.
